-- Advisor Workload Management Functions for Óptima-CX N8N Workflows
-- Execute these statements one by one in your Supabase SQL Editor

-- Step 1: Add required columns to usuarios table
...
-- Step 3: Create workload log table
...
-- Step 4: Enable RLS on log table
ALTER TABLE public.advisor_workload_log ENABLE ROW LEVEL SECURITY;

-- Step 5: Create RLS policy for log table
...
-- Step 6: Function to increment advisor workload
...
-- Step 7: Function to decrement advisor workload
...
-- Step 8: Function to get available sales team
...
-- Step 9: Function to get advisor workload statistics
